export const Card = () => {
  ...
  return (
    <div className="flex flex-col shadow-2xl lg:rounded-bl-[8px] lg:rounded-br-[8px]">
      <div className="lg:h-[216px] lg:w-[635px] lg:rounded-tl-[8px] lg:rounded-tr-[8px] h-[267px] w-[311px] bg-[#fff] py-[24px] px-[25px] lg:py-[40px] lg:px-[40px]">
      ...
      <div className="lg:flex lg:flex-row">
        <div className="lg:h-[259px] lg:w-[317.5px] h-[228px] w-[311px] bg-[#2BB3B1] lg:py-[40px] py-[20px] lg:px-[40px] px-[25px] lg:rounded-bl-[8px]">
          ...
          <button className="h-[48px] w-[263px] lg:w-[237px] bg-[#c0df34] text-[#fff] rounded-[4px] mt-[26px] shadow-lg">
            Sign Up
          </button>
        </div>

        <div className="lg:h-[259px] lg:w-[317.5px] h-[227px] w-[311px] bg-[#4ABEBD] py-[20px] px-[25px] lg:py-[40px] lg:px-[40px] lg:rounded-br-[8px]">
