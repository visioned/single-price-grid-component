  ...
  return (
    <div className="flex flex-col shadow-2xl lg:rounded-bl-[8px] lg:rounded-br-[8px] rounded-[8px]">
      ...
      <div className="lg:flex lg:flex-row">
        ...
        <div className="lg:h-[259px] lg:w-[317.5px] h-[227px] w-[311px] bg-[#4ABEBD] py-[20px] px-[25px] lg:py-[40px] lg:px-[40px] lg:rounded-br-[8px] lg:rounded-bl-none rounded-b-[6px] ">
